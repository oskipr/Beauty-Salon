      ...
      <div className="container-narrow mx-auto">
        ...
        >
          ...
          <p className="text-lg text-muted-foreground font-sans font-light leading-relaxed mb-6">
            En Beauty Salon PR creemos que cada cliente es único. Nuestro equipo
            de estilistas expertos combina técnica impecable con atención
            personalizada, creando experiencias que van más allá de un simple
            corte de cabello.
          </p>
